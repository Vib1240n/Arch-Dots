...
map({ "n", "v" }, "<leader>E", action "workbench.view.explorer", { desc = "Focus explorer" })
...
-- WINDOW NAVIGATION
-- ═══════════════════════════════════════════════════════════════
map({ "n" }, "<A-h>", action "workbench.action.focusLeftGroup", { desc = "Left group" })
map({ "n" }, "<A-j>", action "workbench.action.focusBelowGroup", { desc = "Below group" })
map({ "n" }, "<A-k>", action "workbench.action.focusAboveGroup", { desc = "Above group" })
map({ "n" }, "<A-l>", action "workbench.action.focusRightGroup", { desc = "Right group" })
